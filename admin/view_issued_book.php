<?php
	...
	$student_name = "";
	$issue_date ="";
	$query = "select issued_books.book_name,issued_books.issue_date,issued_books.book_author,users.name from issued_books left join users on issued_books.student_id = users.id";
?>
<!DOCTYPE html>
<html>
<head>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="admin_dashboard.php">TULY's LIBRARY</a>
			</div>
